...
const double EXPLOITATION_RATE = 0.5; //0.9; // between 0 and 1 (it is a threshould for the probability)
const double GOAL_TOLERANCE = 0.05; // it means 1 cm
const int MAX_NUM_EXP_PER_VERTEX = 1000; // maximum number of times that a certain vertex can be used for an expansion attempt (both successful or not)
...
const double WORKSPACE_RADIUS_HAND = 0.3;
